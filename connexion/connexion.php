    ...
    <div class="signin">
        <div class="back-img">
            <div class="sign-in-text">
                <h2 class="active">Ligue 1 experience</h2>
                <h2 class="nonactive">Connexion</h2>
            </div>
            <div class="layer"></div>
            <p class="point">&#9650;</p>
        </div>
        <div class="form-section">
            <form action="#">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <span class="mdl-textfield__error">Entrer email valide</span>
                </div>
                <br />
                <br />
                ...
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <span class="mdl-textfield__error">Au moins 8 caracters</span>
                </div>
                <br />
                <p class="forgot-text">Oublier mot de passe?</p>
                <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1">
                    <input type="checkbox" id="checkbox-1" class="mdl-checkbox__input" checked />
                    <span class="keep-text mdl-checkbox__label">Rester connecté</span>
                </label>
            </form>
        </div>
